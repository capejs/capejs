...
Cape.extend(Component.prototype, {
  ...
  refresh: function() {
    ...
    if (this._.tree) {
      ...
      global.Cape.deepExtend(this._.forms, this.virtualForms);
      ...
      this._.tempForms = global.Cape.deepExtend({}, this.virtualForms);
  ...
  setValuesOfNestedFields: function(formName, prefix, obj) {
    ...
    for (key in obj) {
      ...
      if (typeof obj[key] === 'object') {
        ...
        this.main.virtualForms[formName][attrName] = obj[key];
      }
    }
  },
