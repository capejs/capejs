...
//   nestedIn: the string that is inserted between path prefix and the resource name.
//     Default value is ''.
...
Cape.extend(CollectionAgent.prototype, {
  ...
  pathPrefix: function() {
    var prefix = this.options.basePath || '/';
    if (this.options.nestedIn) prefix = prefix + this.options.nestedIn;
    return prefix;
  },
