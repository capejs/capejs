...
class CollectionAgent {
  ...
  get(actionName, id, params, callback, errorHandler) {
    this._.request('GET', actionName, id, params, callback, errorHandler)
  }

  head(actionName, id, params, callback, errorHandler) {
    this._.request('HEAD', actionName, id, params, callback, errorHandler)
  }

  post(actionName, id, params, callback, errorHandler) {
    this._.request('POST', actionName, id, params, callback, errorHandler)
  }

  patch(actionName, id, params, callback, errorHandler) {
    this._.request('PATCH', actionName, id, params, callback, errorHandler)
  }

  put(actionName, id, params, callback, errorHandler) {
    this._.request('PUT', actionName, id, params, callback, errorHandler)
  }

  delete(actionName, id, params, callback, errorHandler) {
    this._.request('DELETE', actionName, id, params, callback, errorHandler)
  }
...
class _Internal {
  ...
  request(verb, actionName, id, params, callback, errorHandler) {
