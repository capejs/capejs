...
Cape.createComponentClass = function(methods) {
  ...
  Object.assign(klass.prototype, Cape.Component.prototype, methods);
  return klass;
}
...
Cape.createPartialClass = function(methods) {
  ...
  Object.assign(klass.prototype, Cape.Partial.prototype, methods);
  return klass;
}
...
Cape.createCollectionAgentClass = function(methods) {
  ...
  Object.assign(klass.prototype, Cape.CollectionAgent.prototype, methods);
  return klass;
}
