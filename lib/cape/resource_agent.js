...
Cape.extend(ResourceAgent.prototype, {
  ...
  create: function(afterCreate, errorHandler) {
    this.ajax('POST', this.collectionPath(), afterCreate, errorHandler);
    return false;
  },

  update: function(afterUpdate, errorHandler) {
    this.ajax('PATCH', this.memberPath(), afterUpdate, errorHandler);
    return false;
  },

  destroy: function(afterDestroy, errorHandler) {
    this.ajax('DELETE', this.memberPath(), afterDestroy, errorHandler);
    return false;
  },
