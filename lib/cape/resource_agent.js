...
class _Internal {
  ...
  initialDataHandler(data, afterInitialize) {
    this.parseData(data)
    this.postProcess(afterInitialize)
  }

  parseData(data) {
    let paramName = this.main.paramName || this.main.resourceName
