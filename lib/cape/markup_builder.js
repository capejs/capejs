...
Object.assign(MarkupBuilder.prototype, {
  ...
  checkBox: function(attrName, options) {
    ...
    if (attrName.slice(-2) !== '[]') {
      this._.elements.push(
        this._.h('input', global.Object.assign({},
...
Object.assign(_Internal.prototype, {
  ...
  generateAttributes: function(options) {
    ...
    options = options || {};
    options = global.Object.assign({}, this.attr, options);
    this.attr = {};
    ...
    data = global.Object.assign({}, this.data, data);
    this.data = {};
    options.dataset = data;

    if (typeof options.style === 'object')
      options.style = global.Object.assign({}, this.style, options.style);
    else
