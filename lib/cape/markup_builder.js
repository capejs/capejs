...
class MarkupBuilder {
  ...
  hiddenField(name, options) {
    return this._stringField('hidden', name, options)
  }

  textField(name, options) {
    options = options || {}
    return this._stringField(options.type || 'text', name, options)
  }

  passwordField(name, options) {
    return this._stringField('password', name, options)
  }

  _stringField(type, name, options) {
    options = options || {}
    options.type = type
    options.name = name
  ...
  attr(name, value) {
    return this._.setValue(this._.attr, name, value)
  }

  class(name) {
    return this._.setValue(this._.classNames, name, true)
  }

  data(name, value) {
    return this._.setValue(this._.data, name, value)
  }

  css(name, value) {
    return this._.setValue(this._.style, name, value)
  }
...
class _Internal {
  ...
  extractOptions(args) {
    return this.extract('object', args)
  }

  extractCallback(args) {
    return this.extract('function', args)
  }
